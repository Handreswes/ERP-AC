...
CREATE TABLE IF NOT EXISTS public.transit_orders (
    ...
    "amount" DECIMAL(12, 2) DEFAULT 0,
    "items" JSONB DEFAULT '[]'::jsonb,
    "fobTotal" DECIMAL(12, 2) DEFAULT 0,
    "maritimeFreight" DECIMAL(12, 2) DEFAULT 0,
    "localFreight" DECIMAL(12, 2) DEFAULT 0,
    "additionalExpenses" DECIMAL(12, 2) DEFAULT 0,
    "initialPayment" DECIMAL(12, 2) DEFAULT 0,
    "finalPayment" DECIMAL(12, 2) DEFAULT 0,
    "date" TEXT,
